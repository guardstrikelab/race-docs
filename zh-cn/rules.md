...
在 [**场景页面 - 训练场景**](zh-cn/scenarios.md#61-训练场景) 中，对每个训练场景进行详细介绍，其中包含 `10` 个演练赛阶段使用的场景。
...
> 严禁恶意使用或攻击大赛的基础设施，包括用于运行该服务的所有软件和硬件。这些行为可能导致团队被禁止参赛。
