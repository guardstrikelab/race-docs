...
| train27-advanced3                            | Two Sequential Events:<br />1.The Ego Vehicle is Making a Left Turn at an Intersection, and there is a Vehicle Going Straight Across on the Opposite Side;<br />2.A Vulnerable Road User is Crossing the Road in Front of the Host Vehicle. | Day、Foggy |81.52 |33    |
